...
export default function ToolsSection({ tools }) {
  return (
    <section id="tools" className="py-16 sm:py-20 px-4 md:px-12 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl sm:text-4xl font-bold mb-8 sm:mb-12 text-center">Tools & Technologies</h2>
